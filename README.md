...
**Scope:** LLM editorial agent · quality gates · Next.js + Python + PostgreSQL · auto-distribution & watchdogs.
...
`TypeScript` · `React / Next.js` · `Node.js` · `Python` · `PostgreSQL / Firebase` · `Payment & banking integrations` · `LLM agents & automation` · `Vercel / Cloudflare`

I pick tools for fit and longevity, not novelty.
