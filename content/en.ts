...
export const en: Dictionary = {
  ...
  hero: {
    eyebrow: "// Software developer · Fintech & product",
    role: "Custom software development",
    headline: "Custom software that grows your",
    ...
    bullets: [
      ...
      "Fintech integrations: KYC/KYB, settlement, multi-currency",
      "Internal process automation",
    ],
    ctaPrimary: "See projects",
    ctaSecondary: "Book a free intro call",
  ...
  services: {
    ...
    ctaText: "Every project includes a free 30-minute intro consultation.",
    cta: "Let's start",
  },
  process: {
    eyebrow: "// 03 — Process",
  ...
  about: {
    ...
    principles: [
      "Correctness and auditability first",
      "End-to-end ownership, not just code",
      "Iterative, measurable delivery",
      "Simple decisions that scale",
    ],
  ...
  language: { toggle: "Switch language", label: "EN" },
}
